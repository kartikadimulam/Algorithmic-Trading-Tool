...
data = yf.download('V', start='2021-12-25', end='2023-05-04')
...
garch = arch_model(train_set['Daily Returns'], vol='EGarch',
                   p=1, q=1, dist='t')
