...
path = '/Users/kartika/Downloads/PythonForTrading/Simulated_Duplicate_Values.csv'
...
print(df)
path ='/Users/kartika/Downloads/PythonForTrading/Simulated_Missing_Values.csv'
...
df = pd.read_csv('/Users/kartika/downloads/PythonForTrading/Simulated_Inconsistent_Data.csv',
                 index_col="DATE", usecols=['DATE','OPEN','HIGH','LOW','CLOSE'], parse_dates=True)

df['CLOSE'].diff() > 25

path ='/Users/kartika/downloads/PythonForTrading/1_min-MARUTI.csv'
